...
namespace E_Ticaretim.Areas.Seller.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public BrandsController(E_TicaretimContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return _context.Brands != null ? 
                          ...
                          Problem("Entity set 'E_TicaretimContext.Brands'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(short id)
        {
            ...
            {
                return Problem("Entity set 'E_TicaretimContext.Brands'  is null.");
            }
            var brand = await _context.Brands.FindAsync(id);
            if (brand != null)
            {
