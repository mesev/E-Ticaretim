...
{
    [DbContext(typeof(E_TicaretimContext))]
    partial class E_TicaretimContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Brand", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.City", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.ItemStatus", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.OrderDetailStatus", b =>
                {
            ...
            modelBuilder.Entity("E_Ticaretim.Models.PaymentMethod", b =>
                {
                    b.Property<short>("PaymentMethodId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Product", b =>
                {
                    b.Property<long>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Seller", b =>
                {
                    b.Property<int>("SellerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Order", b =>
                {
                    b.HasOne("E_Ticaretim.Models.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Ticaretim.Models.PaymentMethod", "PaymentMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Ticaretim.Models.OrderDetail", b =>
                {
                    b.HasOne("E_Ticaretim.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Ticaretim.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("E_Ticaretim.Models.OrderDetailStatus", b =>
                {
                    b.HasOne("E_Ticaretim.Models.ItemStatus", "ItemStatus")
                        .WithMany()
                        .HasForeignKey("ItemStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Ticaretim.Models.OrderDetail", "OrderDetail")
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Product", b =>
                {
                    b.HasOne("E_Ticaretim.Models.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Ticaretim.Models.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("E_Ticaretim.Models.Seller", "Seller")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("E_Ticaretim.Models.Seller", b =>
                {
                    b.HasOne("E_Ticaretim.Models.City", "City")
                        .WithMany()
